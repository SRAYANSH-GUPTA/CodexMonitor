...
Canonical navigation guide for Hopper. Use this as: "if you need X, edit Y".
...
6. Daemon RPC method parity: `src-tauri/src/bin/hopper_daemon/rpc.rs`
7. Daemon state/wiring implementation: `src-tauri/src/bin/hopper_daemon.rs`
8. Standalone daemon lifecycle CLI: `src-tauri/src/bin/hopper_daemonctl.rs`
...
- Daemon entrypoint and state/wiring: `src-tauri/src/bin/hopper_daemon.rs`
- Daemon lifecycle CLI (headless start/stop/status): `src-tauri/src/bin/hopper_daemonctl.rs`
- Daemon JSON-RPC dispatcher/router: `src-tauri/src/bin/hopper_daemon/rpc.rs`
- Daemon domain handlers: `src-tauri/src/bin/hopper_daemon/rpc/*`
- Daemon transport: `src-tauri/src/bin/hopper_daemon/transport.rs`
