...
const STORAGE_KEY_SIDEBAR = "hopper.sidebarWidth";
const STORAGE_KEY_RIGHT_PANEL = "hopper.rightPanelWidth";
const STORAGE_KEY_CHAT_DIFF_SPLIT_POSITION_PERCENT =
  "hopper.chatDiffSplitPositionPercent";
const STORAGE_KEY_PLAN_PANEL = "hopper.planPanelHeight";
