...
describe("Messages", () => {
  ...
  it("routes markdown href file paths through the file opener", () => {
    const linkedPath =
      "/Users/dimillian/Documents/Dev/Hopper/src/features/messages/components/Markdown.tsx:244";
    const items: ConversationItem[] = [
      {
    ...
    expectOpenedFileTarget(
      openFileLinkMock,
      "/Users/dimillian/Documents/Dev/Hopper/src/features/messages/components/Markdown.tsx",
      244,
    );
  });
  ...
  it("routes absolute href file paths with #L anchors through the file opener", () => {
    const linkedPath =
      "/Users/dimillian/Documents/Dev/Hopper/src/features/messages/components/Markdown.tsx#L244";
    const items: ConversationItem[] = [
      {
  ...
  it("routes dotless workspace href file paths through the file opener", () => {
    const linkedPath = "/workspace/Hopper/LICENSE";
    const items: ConversationItem[] = [
      {
  ...
  it("renders absolute file references as workspace-relative paths", () => {
    const workspacePath = "/Users/dimillian/Documents/Dev/Hopper";
    const absolutePath =
      "/Users/dimillian/Documents/Dev/Hopper/src/features/messages/components/Markdown.tsx:244";
    const items: ConversationItem[] = [
      {
