...
app_path="${1:-src-tauri/target/release/bundle/macos/Hopper.app}"
...
bin_path="${app_path}/Contents/MacOS/hopper"
daemon_path="${app_path}/Contents/MacOS/hopper_daemon"
daemonctl_path="${app_path}/Contents/MacOS/hopper_daemonctl"
daemon_source="${DAEMON_BINARY_PATH:-src-tauri/target/release/hopper_daemon}"
daemonctl_source="${DAEMONCTL_BINARY_PATH:-src-tauri/target/release/hopper_daemonctl}"
